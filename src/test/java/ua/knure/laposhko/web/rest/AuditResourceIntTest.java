...
import ua.knure.laposhko.StudForumApp;
import ua.knure.laposhko.config.audit.AuditEventConverter;
import ua.knure.laposhko.domain.PersistentAuditEvent;
import ua.knure.laposhko.repository.PersistenceAuditEventRepository;
import ua.knure.laposhko.service.AuditEventService;
...
@SpringBootTest(classes = StudForumApp.class)
@Transactional
