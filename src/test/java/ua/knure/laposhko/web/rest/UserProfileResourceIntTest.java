...
public class UserProfileResourceIntTest {
    ...
    public void createUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getPass()).isEqualTo(DEFAULT_PASS);
    ...
    public void createUserProfileWithExistingId() throws Exception {
        ...
        restUserProfileMockMvc.perform(post("/api/user-profiles")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingUserProfile)))
    ...
    public void updateUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getPass()).isEqualTo(UPDATED_PASS);
